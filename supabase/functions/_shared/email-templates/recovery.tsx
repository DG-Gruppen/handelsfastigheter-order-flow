  ...
  <Html lang="sv" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        <div style={header}>
          <Heading style={headerTitle}>🔐 Återställ lösenord</Heading>
        </div>
        <div style={content}>
          <Heading style={h1}>Återställ ditt lösenord</Heading>
          <Text style={text}>
            Vi har tagit emot en begäran om att återställa ditt lösenord för {siteName}. Klicka på knappen nedan för att välja ett nytt lösenord.
          </Text>
